...
const MyJobs = () => {
    const email = "suyog123@gmail.com"
...
const jobsPerPage = 4;
    ...
    useEffect(()=>{
        setIsLoading(true)
        fetch(`http://localhost:4000/my-jobs/suyog@gmail.com`)
        .then(res =>res.json())
    ...
    <div className='max-w-screen-2xl container mx-auto xl:px-24 px-4'>
        <div className='my-jobs-container'>
            ...
            <div className='search-box p-2 text-center mb-2'>
                ...
                <button className='bg-blue text-white font-semibold px-8 py-2 rounded-sm mb-4 ' onClick={handleChange}>Search</button>
            </div>
        </div>
  ...
  <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-lg rounded ">
    <div className="rounded-t mb-0 px-4 py-3 border-0">
      <div className="flex flex-wrap items-center">
        ...
        <div className="relative w-full px-4 max-w-full flex-grow flex-1 text-right">
          <Link to='/post-jobs'>
          <button className="bg-indigo-500 text-white active:bg-indigo-600 text-xs font-bold uppercase px-3 py-1 rounded outline-none focus:outline-none mr-1 mb-1 ease-linear transition-all duration-150" type="button">Post Jobs</button>
          </Link>
        </div>
      </div>
    </div>
    ...
    <div className="block w-full overflow-x-auto">
      <table className="items-center bg-transparent w-full border-collapse ">
        ...
        {
            isLoading ? (<div className='flex items-center justify-center h-20'><p>Lodding...</p></div>) : (
